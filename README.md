...
I am a **Mechatronics Engineering** student at the **National University of Colombia**, currently in my **10th semester**.  
I’m passionate about **embedded systems, automation, and control**, combining programming, electronics, and mechanical design to create functional engineering solutions.  

Currently, I am a **researcher at Kyma Research Group (UNAL)**, working on the **MotoresIoT project**, focused on remote monitoring and control of electric motors through IoT-based systems.

### 🧩 Areas of Interest
- Embedded Systems (ESP32, Arduino, microcontrollers)
- PID Control and basic automation
- Structured and OOP programming
- Python, C, C++, and JavaScript
- Technical documentation with LaTeX
- Development on Linux and GitHub

### 🌐 English Level
- **B1 (Intermediate)** – technical reading and written communication
